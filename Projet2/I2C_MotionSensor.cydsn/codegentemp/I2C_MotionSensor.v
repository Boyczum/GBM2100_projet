// ======================================================================
// I2C_MotionSensor.v generated from TopDesign.cysch
// 03/28/2021 at 10:27
...
module SCB_I2C_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("5f569bb0-8ae9-40fe-ba50-0b44870fc5a7/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("5f569bb0-8ae9-40fe-ba50-0b44870fc5a7/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("5f569bb0-8ae9-40fe-ba50-0b44870fc5a7/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("08af3843-cb7b-4a47-b68f-295029932231/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("08af3843-cb7b-4a47-b68f-295029932231/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("08af3843-cb7b-4a47-b68f-295029932231/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
	...
	wire [0:0] tmpIO_0__Pin_AnyMotion_INT_net;
	electrical [0:0] tmpSIOVREF__Pin_AnyMotion_INT_net;

	cy_mxs40_gpio_v1_0
		#(.id("3816c3f1-d930-4e65-aace-fa02ab3c1d1e"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("3"),
		  .ibuf_enabled("1"),
		...
		Pin_AnyMotion_INT
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_15}),
		  .io({tmpIO_0__Pin_AnyMotion_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_AnyMotion_INT_net));
	...
	wire [0:0] tmpFB_0__MAX_power_net;
	wire [0:0] tmpIO_0__MAX_power_net;
	electrical [0:0] tmpSIOVREF__MAX_power_net;
	...
	cy_mxs40_gpio_v1_0
		...
		MAX_power
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAX_power_net[0:0]}),
		  .io({tmpIO_0__MAX_power_net[0:0]}),
		  .siovref(tmpSIOVREF__MAX_power_net));
